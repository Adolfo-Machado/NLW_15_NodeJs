...
CREATE TABLE "new_attendees" (
    ...
    CONSTRAINT "attendees_envent_id_fkey" FOREIGN KEY ("envent_id") REFERENCES "events" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_attendees" ("created_at", "email", "envent_id", "id", "name") SELECT "created_at", "email", "envent_id", "id", "name" FROM "attendees";
